...
<p>Building a queue on cassandra isn't a trivial task and is rife with problems.  In fact, this is pretty well known and in general the consensus is <em>don't build a queue on Cassandra</em>.  </p>
